function findLeastAverageStudent(studentInfo){
    ...
    for(let infoIndex = 0; infoIndex < studentInfo.length; infoIndex++){
        if(typeof studentInfo[infoIndex].english != 'number' || typeof studentInfo[infoIndex].maths != 'number' || typeof studentInfo[infoIndex].science != 'number' || typeof studentInfo[infoIndex].social != 'number' || typeof studentInfo[infoIndex].first_name != 'string' || typeof studentInfo[infoIndex].last_name != 'string' || studentInfo[infoIndex].last_name.length <= 0 || studentInfo[infoIndex].first_name.length <= 0){
            return "Provide proper marks/name for the students";
        }
        const average = (studentInfo[infoIndex].english + studentInfo[infoIndex].maths + studentInfo[infoIndex].science + studentInfo[infoIndex].social)/4;
        averageOfStudents.push(average);
    }
    let leastAverageStudentIndex = averageOfStudents.indexOf(Math.min(...averageOfStudents));
    return "Least average student is " + studentInfo[leastAverageStudentIndex].first_name + ' ' + studentInfo[leastAverageStudentIndex].last_name;
}

console.log(findLeastAverageStudent([
