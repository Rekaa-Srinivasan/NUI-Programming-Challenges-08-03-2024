function findBestAverageStudent(studentInfo){
    ...
    let bestAverageStudentIndex = averageOfStudents.indexOf(Math.max(...averageOfStudents));
    return "Least average student is " + studentInfo[bestAverageStudentIndex].first_name + ' ' + studentInfo[bestAverageStudentIndex].last_name;
}

console.log(findBestAverageStudent([
